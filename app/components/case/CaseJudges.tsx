...
import { judgesList } from "~/data/statics"

export default function CaseJudges() {
	return (
		<section id="Judges" className="w-full">
			<div className="container min-h-screen px-4 mx-auto 2xl:max-w-screen-xl">
				...
				<div className="container px-4 mx-auto">
					<div className="max-w-3xl mx-auto mb-12 text-center lg:mb-20">
						<h2 className="mt-8 mb-10 text-4xl font-semibold uppercase" >
							Ban giám khảo
						</h2>
					...
					<div className="flex flex-wrap -m-3">
						{judgesList.map( judge => (
							<div key={judge.name} className="w-full p-3 md:w-1/2 lg:w-1/3">
							<div className="p-6 pb-12 text-center border rounded-xl">
								<img className="object-cover w-full mx-auto mb-6 rounded-lg md:w-80 h-80" src={judge.img} alt={judge.name} />
